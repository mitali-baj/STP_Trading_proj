...
export const newsItems = [
  { sentiment: 'Positive', ticker: 'GOOGL', headline: "Google reveals new AI models with a focus on safety and openness.", color: 'green' },
  { sentiment: 'Negative', ticker: 'META', headline: "Zuckerberg targets AI assistant supremacy over Siri, Alexa, and ChatGPT, aiming for market lead by year's end.", color: 'red' },
  { sentiment: 'Positive', ticker: 'GOOGL', headline: "Google reveals new AI models with a focus on safety and openness.", color: 'green' },
  { sentiment: 'Negative', ticker: 'META', headline: "Zuckerberg targets AI assistant supremacy over Siri, Alexa, and ChatGPT, aiming for market lead by year's end.", color: 'red' },
  { sentiment: 'Positive', ticker: 'GOOGL', headline: "Google reveals new AI models with a focus on safety and openness.", color: 'green' },
  { sentiment: 'Negative', ticker: 'META', headline: "Zuckerberg targets AI assistant supremacy over Siri, Alexa, and ChatGPT, aiming for market lead by year's end.", color: 'red' },
